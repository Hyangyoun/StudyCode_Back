...
public interface PostRepository extends JpaRepository<PostEntity, Long> {
    ...
    @Query("select p.postIndex as postIndex, p.recommend as recommend, p.title as title, p.content as content, p.postDate as postDate, p.thumbnailPath as thumbnailPath " +
